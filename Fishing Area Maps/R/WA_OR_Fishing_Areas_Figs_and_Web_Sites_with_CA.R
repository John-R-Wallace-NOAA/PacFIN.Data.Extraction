...
WA_OR_Fishing_Areas_Figs_and_Web_Sites_with_CA <- function(INFPC = TRUE, PSFMC = TRUE, WA_State = TRUE, WA_State_Web = FALSE, OR_State_Web = FALSE, CA_State_Web = FALSE) {
    ...
    if(PSFMC) {
        ...
        abline(h = PSFMC_Lats[-2], col = 'red')
        lines(c(-130, -124.22465), c(42, 42), col = 'red')
        lines(c(-124.72538, -126.08921), c(48.51094, 47.35), col = 'red')
    ...
    if(WA_State) {
        ...
        abline(h = WA_Lats[-1], col = 'green4')
        lines(c(-130, -124.22465), c(42, 42), col = 'green4')
